...
## フォームの送信先
push @mailto,'contact@mizu-shinkyu.com';
##contact@mizu-shinkyu.com
...
$config{'ThanksPage'} = 'https://mizu-shinkyu.com/wp/thank/';
...
--------------------------------------------------
[ 送信日時 ] <_mfp_date_>
[ フォームに付く前のURL ] <_mfp_referrer_>
[ コンバージョンレート ] <_mfp_cvr_>
...
<_お名前_>  様
お問い合せいただきありがとうございます。
内容を確認し、担当者より折り返しご連絡いたしますので、しばらくお待ち下さい。
...
————————————————–
みず鍼灸院
〒486-0833　愛知県春日井市上条町１丁目１７６ エクセル春日井２０５​
TEL: 0568-86-2185
————————————————–
__return_body__
